...
#код определяет абстрактный базовый класс Интеграл и два его подкласса
#Sympsons и Trapeze. Оба они реализуют метод calc()  который вычисляет приближенное значение определенного интеграла 
